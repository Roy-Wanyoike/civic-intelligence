module github.com/Roy-Wanyoike/civic-intelligence/adapters/kenya
...
replace github.com/Roy-Wanyoike/civic-intelligence/services/legislation => ../../services/legislation
