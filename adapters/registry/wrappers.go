...
// MustRegisterDefault registers the 6 default country adapters (Kenya,
// Uganda, Tanzania, Ghana, Nigeria, South Africa) using fresh adapter
// instances constructed with zero-value Dependencies. It is safe to call
// multiple times — subsequent calls are no-ops once the adapters are
// registered.
//
