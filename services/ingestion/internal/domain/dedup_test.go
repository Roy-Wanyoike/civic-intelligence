...
func (f *fakeAdapter) CountryName() string                                   { return "Fake" }
func (f *fakeAdapter) LegislativeStructure() contracts.LegislativeStructure { return contracts.LegislativeStructure{CountryCode: f.country} }
func (f *fakeAdapter) BillStages() []contracts.StageDefinition               { return nil }
func (f *fakeAdapter) Terminology() []contracts.TermDefinition               { return nil }
